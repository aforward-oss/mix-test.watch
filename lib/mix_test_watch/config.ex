defmodule MixTestWatch.Config do
  ...
  defstruct tasks:            @default_tasks,
            ...
            ansi_enabled:     @default_ansi_enabled,
            cli_args:         []
  ...
  defp get_ansi_enabled do
    Application.get_env(:mix_test_watch, :ansi_enabled,
                        @default_ansi_enabled)
  end
